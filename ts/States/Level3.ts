module BoilerPlate {
    export class Level3 extends Phaser.State implements Fabrique.IState {
        ...
        public create(): void {
            ...
            myEnemy = this.enemies.create(this.game.world.centerX, 100, Images.enemyBlue);
            myEnemy.anchor.setTo(0.5, 0.5);
            this.game.physics.enable(myEnemy, Phaser.Physics.ARCADE);

            myEnemy = this.enemies.create(this.game.world.centerX, 500, Images.enemyBlue);
            myEnemy.anchor.setTo(0.5, 0.5);
            this.game.physics.enable(myEnemy, Phaser.Physics.ARCADE);
            //
            ...
            this.score = 8;
            this.scoreText = this.game.add.text(16, 16, 'ENEMIES LEFT: 8', {font: '24px Times New Roman', fill: '#ff0000'});
        ...
        public collisionHandler(fireball: Phaser.Sprite, enemy: Phaser.Sprite): void {
            ...
            if (this.enemies.countDead() === 4) {
                this.powerUp();
            }
            if (this.enemies.countLiving() < 2 && this.enemies.countDead() < 7) {
        ...
        public powerK(playerShip: Phaser.Sprite, powerUp: Phaser.Sprite): void {
            ...
            this.lasers.removeBetween(0, 3, true);
            powerUp.kill();
            this.fireRate -= 350;
        }
        public return(): void {
