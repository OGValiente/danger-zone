...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
            dev: {
                files: [
                    {expand: true, cwd: 'tasks', dest: '_build/dev/tasks', src: ['**/*']},
            ...
            dist: {
                files: [
                    {expand: true, cwd: 'assets/audio', dest: '_build/dist/assets/audio', src: ['**/*']},
                    {expand: true, cwd: 'assets/gfx', dest: '_build/dist/assets/gfx', src: ['**/*']},
